                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jafung" class="form-control">
                            <option value="Tutor(Pengajar)">Tutor(Pengajar)</option>
                            <option value="Lecturer(Asisten Ahli)">Lecturer(Asisten Ahli)</option>
                            <option value="Senior Lecturer(Lektor)">Senior Lecturer(Lektor)</option>
                            <option value="Associate Professor(Lektor Kepala)">Associate Professor(Lektor Kepala)</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id_scholar" required>
                    <div class="form-group">
                        <label>ID Sinta</label>
                        <input type="text" class="form-control" name="id_sinta" required>
                    <div class="form-group">
