        ...
        <div class="panel panel-default">
            ...
            <div id="widget1" class="panel-body collapse in">
                <div class="modal-dialog">
                    ...
                    <?php } ?>
                    <form action="<?php echo site_url('skema/update_data')?>" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="id_skema" value="<?php echo $id_skema;?>">
                       <div class="modal-body">
                            <div class="form-group">
                                <label>Skema Penelitian</label>
                                <input type="text" name="skema" class="form-control" value="<?php echo $skema;?>">
                            </div>
                            <div class="form-group">
                                <label>Luaran Penelitian</label>
                                <input type="text" name="luaran" class="form-control" value="<?php echo $luaran;?>">
                            </div>
                        </div>
