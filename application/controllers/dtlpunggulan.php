...
class Dtlpunggulan extends CI_Controller{
    ...
    public function index(){
        $data = array(
            ...
            'data_npj' => $this->model->GetTotDtlp('where laporan.npj = "Endhul"')->result_array(),
            'content' => 'dtlp/dtlp-dataunggulan',
            'data_laporan' => $this->model->GetTotDtlpU('where laporan.npj ="'.$this->session->userdata('ses_nama').'"  order by years_name asc')->result_array(),
        );
