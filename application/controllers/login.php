...
class Login extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->session->unset_userdata('ses_active');
    ...
    public function sign_in(){
        ...
        $cek_login = $this->model->GetUser("where username = '$username' and password = '$password' and active = 1")->num_rows();
        ...
        if ($cek_login == 1){
            ...
            $this->session->set_flashdata('error','Maaf anda gagal login atau akun anda belum aktif');
            redirect('login');
        }
    }
